...
public class ItemWeaponController : MonoBehaviour
{
    ...
    public void OnTriggerEnter(Collider other)
    {
        ...
        {
            gameObject.SetActive(false);
             enemy.GetComponentInChildren<Horn>().transform.localScale += new Vector3(0, 0.05f, 0);
             enemy.GetComponentInChildren<Horn>().transform.localPosition += new Vector3(0, 0.05f, 0);
